...
// === Body ===
var ASM_CONSTS = {
  310712: ($0, $1, $2, $3) => setTimeout(() => window.inkWasmRegistry[$3].dynCall_vi($1, $2), $0),
  310793: $0 => {
    clearTimeout($0);
  },
  310815: ($0, $1) => {
  ...
  311245: $0 => window.inkHostRegistry[$0].shouldPreloadShaders(),
  311307: $0 => window.inkHostRegistry[$0].shouldRegisterDocument(),
  311371: ($0, $1, $2, $3, $4, $5) => {
  ...
  314529: () => (typeof wasmOffsetConverter !== "undefined")
};
...
var PThread = {
  ...
  allocateUnusedWorker() {
    ...
    } else worker = new Worker(pthreadMainJs, workerOptions);
    PThread.unusedWorkers.push(worker);
  },
  getNewWorker() {
...
/* Magic ID for Emscripten 'default surface' */ function _eglGetCurrentContext() {
...
function _eglGetCurrentSurface(readdraw) {
  ...
  if (readdraw == 12378) /* EGL_READ */ {
    return EGL.currentReadSurface;
  } else if (readdraw == 12377) /* EGL_DRAW */ {
...
/* EGL_FALSE */ var readEmAsmArgsArray = [];
